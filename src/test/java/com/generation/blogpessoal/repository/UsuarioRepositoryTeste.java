...
public class UsuarioRepositoryTeste {
    ...
    void start() {
        ...
        usuarioRepository.save(new Usuario(0L, "João da Silva", "https://i.imgur.com/h48loa.jpg","joao@email.com.br","123465278"));

        usuarioRepository.save(new Usuario(0L, "Manuela da Silva", "https://i.imgur.com/NtyGneo.jpg","manuela@email.com.br","13465278"));

        usuarioRepository.save(new Usuario(0L, "Adriana da Silva", "https://i.imgur.com/5M2pMb.jpg","adriana@email.com.br","13465278"));
